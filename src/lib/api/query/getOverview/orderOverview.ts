...
export const GET_ORDER_OVERVIEW = async (): Promise<AxiosResponse<OrderOverview>> =>
  await axios.get(ORDER_OVERVIEW_URL)

export const GET_PAYMENT_OVERVIEW = async (): Promise<AxiosResponse<PaymentOverview>> =>
